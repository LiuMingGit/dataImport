 ...
 */
package vip.xiaonuo.dm.dt.enums;
...
public enum DmDataSourceExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        DmDataSourceExceptionEnum(Integer code, String message) {
        this.code = code;
