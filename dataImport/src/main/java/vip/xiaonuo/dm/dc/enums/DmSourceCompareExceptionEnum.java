 ...
 */
package vip.xiaonuo.dm.dc.enums;
...
public enum DmSourceCompareExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        DmSourceCompareExceptionEnum(Integer code, String message) {
        this.code = code;
